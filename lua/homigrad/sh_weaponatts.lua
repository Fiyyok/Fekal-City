...
hg.attachments.sight = {
	...
	["holo18"] = {
		"sight",
		"models/weapons/arc9/darsu_eft/mods/scope_elcan_specter_hco.mdl",
		Angle(0, 0, -90),
		offset = Vector(-1, 0, -0.02),
		offsetView = Vector(-1.7, -0.03, 9),
		{},
		mountType = "picatinny",
		holotex = "models/weapons/arc9/darsu_eft/mods/transparent_glass",
		holo = Material("vgui/arc9_eft_shared/reticles/new/scope_all_eotech_xps3-2_marks.png"),
		holo_size = CLIENT and ScreenScale(0.35) or 1, --size of the holo
		PhysModel = "models/hunter/plates/plate025.mdl",
		PhysPos = Vector(0, 0, 0),
	...
	["holo19"] = {
		"sight",
		"models/weapons/arc9/darsu_eft/mods/scope_all_vortex_razor_amg_uh-1.mdl",
		Angle(0, 0, -90),
		offset = Vector(-1, 0, -0.02),
		offsetView = Vector(-1.5, 0, 9),
		{
	...
	["holo21"] = {
		"sight",
		"models/weapons/arc9/darsu_eft/mods/scope_wilcox_boss.mdl",
		Angle(0, 0, -90),
		offset = Vector(-1, 0, -0.02),
		offsetView = Vector(-1.9, -0.03, 9),
		{},
		mountType = "picatinny",
		holotex = "models/weapons/arc9/darsu_eft/mods/transparent_glass",
		holo = Material("vgui/arc9_eft_shared/reticles/new/scope_all_wilcox_boss_xe_hp_mark_002.png"),
		holo_size = CLIENT and ScreenScale(0.35) or 1, --size of the holo
		PhysModel = "models/hunter/plates/plate025.mdl",
		PhysPos = Vector(0, 0, 0),
		PhysAng = Angle(0, 90, 0),
	...
	["holo22"] = {
		"sight",
		"models/weapons/arc9/darsu_eft/mods/scope_all_vomz_pilad_p1x42_weaver.mdl",
		Angle(0, 0, -90),
		offset = Vector(-1, 0, -0.02),
		offsetView = Vector(-1.35, -0.03, 9),
		{},
		mountType = "picatinny",
		holotex = "models/weapons/arc9/darsu_eft/mods/transparent_glass",
		holo = Material("vgui/arc9_eft_shared/reticles/new/scope_all_vomz_pilad_p1x42_mark_mode_002"),
		holo_size = CLIENT and ScreenScale(1) or 1, --size of the holo
		PhysModel = "models/hunter/plates/plate025.mdl",
		PhysPos = Vector(0, 0, 0),
		PhysAng = Angle(0, 90, 0),
		valid = true,
	...
	["holo23"] = {
		"sight",
		"models/weapons/arc9/darsu_eft/mods/scope_base_aimpoint_acro_p1.mdl",
		Angle(0, 0, -90),
		offset = Vector(-1, 0, -0.02),
		offsetView = Vector(-0.5, -0.03, 9),
		{},
		mountType = "picatinny",
		holotex = "models/weapons/arc9/darsu_eft/mods/transparent_glass",
	...
	["optic14"] = {
		"sight",
		"models/weapons/arc9/darsu_eft/mods/scope_sig_tango6t.mdl",
		Angle(0, 0, -90),
		offset = Vector(2, 1.5, -0.03),
		offsetView = Vector(0, 0, 12),
		{},
	...
	["optic15"] = {
		...
		scopemat = Material("decals/scope.png"),
		mat = Material("effects/arc9/rt"),
		perekrestie = Material("vgui/arc9_eft_shared/reticles/adjustable/vudu_f.png"),
		localScopePos = Vector(2, 0, 0),
		scope_blackout = 2000,
		rot = 0,
		FOVMin = 6,
...
hg.attachments.barrel = {
	...
	["supressor9"] = {
		"barrel", "models/weapons/upgrades/a_suppressor_sec2.mdl", 
		Angle(0, 0, 0), 
		{}, 
		modelscale = 1, 
		offset = Vector(-1.5,0.1,0),
	...
	["supressor10"] = {
		"barrel", "models/weapons/upgrades/a_suppressor_sec.mdl", 
		Angle(0, 0, 0), 
		{}, 
		modelscale = 1, 
		offset = Vector(-1.5,0.1,0),
	...
	["supressor11"] = {
		"barrel", "models/weapons/arc9/darsu_eft/mods/silencer_qdc_kac_qdc_suppressor_556x45.mdl", 
		Angle(0, 0, 0), 
		{}, 
		modelscale = 1, 
		offset = Vector(-1.5,0.1,0),
	...
	["supressor12"] = {
		"barrel", "models/weapons/arc9/darsu_eft/mods/silencer_hex_hexagon_wafflemaker_suppressor_545x39.mdl", 
		Angle(0, 0, 0), 
		{}, 
		modelscale = 1, 
		offset = Vector(-1.5,0.1,0),
	...
	["supressor13"] = {
		"barrel", "models/weapons/arc9/darsu_eft/mods/silencer_akm_zenit_dtk-4m_762x39.mdl", 
		Angle(0, 0, 0), 
		{}, 
		modelscale = 1, 
		offset = Vector(-1.5,0.1,0),
...
hg.attachments.grip = {
	...
	["grip4"] = {
		"grip",
		"models/weapons/arc9/darsu_eft/mods/fg_rk1.mdl",
		Angle(180, 180, 135),
		{},
		offset = Vector(-17, -1.7, -1),
		holdtype = "ar2",
		mountType = "picatinny",
		recoilReduction = 0.5,
		PhysModel = "models/hunter/plates/plate025.mdl",
	...
	["grip7"] = {
		"grip",
		"models/weapons/arc9/darsu_eft/mods/fg_sturmgriff.mdl",
		Angle(-90, 180, 90),
		{},
		offset = Vector(-17, -1.4, 0),
		holdtype = "smg",
		...
		PhysAng = Angle(180, 180, 90),
		LHandPos = Vector(-3,1.8,-3.2),
		LHandAng = Angle(0,-1,0),
		hold = "grip_hold",
		valid = true,
	},
	["grip8"] = {
		"grip",
		"models/weapons/arc9/darsu_eft/mods/fg_pillau_p2.mdl",
		Angle(-90, 180, 90),
		{},
		offset = Vector(-16.9, -1.5, -0.15),
		holdtype = "smg",
		mountType = "picatinny",
		recoilReduction = 0.5,
		PhysModel = "models/hunter/plates/plate025.mdl",
	...
	["grip9"] = {
		"grip",
		"models/weapons/arc9/darsu_eft/mods/fg_mlok_afg.mdl",
		Angle(180, 180, 90),
		{},
		offset = Vector(-16, -1.6, 0),
		holdtype = "smg",
		mountType = "picatinny",
		recoilReduction = 0.8,
		PhysModel = "models/hunter/plates/plate025.mdl",
	...
	["grip5"] = {
		"grip",
		"models/weapons/arc9/darsu_eft/mods/fg_vtacuvg.mdl",
		Angle(180, 180, 90),
		{},
		offset = Vector(-17, -1.4, 0),
		holdtype = "smg",
	...
	["grip6"] = {
		"grip",
		"models/weapons/arc9/darsu_eft/mods/fg_heracqr.mdl",
		Angle(180, 180, 90),
		{},
		offset = Vector(-16, -1.6, 0),
		holdtype = "ar2",
...
local attNames = {
	...
	["supressor9"] = "Really cool suppressor",
	["supressor10"] = "Really cool suppressor2",
	["supressor11"] = "QDC KAC(TAN)",
	["supressor12"] = "Hexagon",
	["supressor13"] = "Zenit DTLC",
	["holo1"] = "EOTech 552",
...
local attachmentsIcons = {
	...
	["supressor9"] = "vgui/icons/silencer_akm",
	["supressor10"] = "vgui/icons/silencer_assaultrifle",
	["supressor11"] = "entities/eft_ar15_attachments/muzzle/kac_qdc_556x45_sound_suppressor.png",
	["supressor12"] = "entities/eft_ak_attachments/muzzle/waffle.png",
	["supressor13"] = "entities/eft_ak_attachments/muzzle/dtk4m.png",
	...
	["holo18"] = "entities/eft_attachments/scopes/hco.png",
	["holo19"] = "entities/eft_attachments/scopes/uh1.png",
	["holo21"] = "entities/eft_attachments/scopes/boss.png",
	["holo22"] = "entities/eft_attachments/scopes/pilad.png",
	["holo23"] = "entities/eft_attachments/scopes/acrop1.png",
	...
	["grip6"] = "entities/eft_attachments/foregrips/cqr.png",
	["grip4"] = "entities/eft_attachments/foregrips/b25u.png",
	["grip5"] = "entities/eft_attachments/foregrips/uvg.png",
	["grip7"] = "entities/eft_attachments/foregrips/sturm.png",
	["grip8"] = "entities/eft_attachments/foregrips/pillau2.png",
	["grip9"] = "entities/eft_attachments/foregrips/mlokafg.png",
}
