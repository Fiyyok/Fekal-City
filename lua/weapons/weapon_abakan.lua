...
SWEP.Author = "Gennadiy Nikonov"
SWEP.Instructions = "The AN-94 is Automatic rifle chambered in 5.45x39 mm\n\nRate of fire 600 (fully automatic) per minute"
SWEP.Category = "Weapons - Assault Rifles"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/tfa_ins2/w_abakan.mdl"
SWEP.WorldModelFake = "models/weapons/tfa_ins2/c_abakan.mdl" -- МОДЕЛЬ ГОВНА, НАЙТИ НОРМАЛЬНЫЙ КАЛАШ
...
SWEP.ZoomPos = Vector(0, -0.33, 4.15)
...
SWEP.WepSelectIcon2 = Material("entities/tfa_ins2_abakan.png")
SWEP.WepSelectIcon2box = true
SWEP.IconOverride = "entities/tfa_ins2_abakan.png"

SWEP.Ergonomics = 1
SWEP.WorldPos = Vector(4, -0.7, -1.1)
